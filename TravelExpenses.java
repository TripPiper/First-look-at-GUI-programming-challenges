...
public class TravelExpenses extends JFrame {
    ...
    private JPanel panel, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12;		                  // to reference a panel
    ...
    private void buildPanel() {
        ...
        p8.add(reimbursementTLabel);

        p8.add(reimbursementTField);

        p8.add(reimbursementALabel);
        p8.add(reimbursementAField);

        p8.add(excessPaidByYouLabel);
        p8.add(excessPaidByYouField);

        p8.add(savedByYouTLabel);
        p8.add(savedByYouTField);

        p8.add(amountReimburseToYouLabel);
        p8.add(amountReimburseToYouField);
